...
/* Note: TIM2_IRQHandler, TIM4_IRQHandler, USART3_IRQHandler are defined in
 * stm32f1xx_it.c (auto-generated by CubeMX, then overlaid by our setup script).
 * They forward to HAL_TIM_IRQHandler() and air780_uart_irq() respectively. */
